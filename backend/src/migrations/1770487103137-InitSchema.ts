...
export class InitSchema1770487103137 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."tenants_category_enum" AS ENUM('grocery', 'greengrocer', 'butcher', 'bakery', 'pharmacy', 'other')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."products_source_enum" AS ENUM('manual', 'catalog', 'order_note')`,
    );
    await queryRunner.query(
