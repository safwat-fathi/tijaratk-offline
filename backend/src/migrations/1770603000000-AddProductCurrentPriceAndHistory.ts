...
export class AddProductCurrentPriceAndHistory1770603000000
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "products" ADD "current_price" numeric(10,2)`,
    );
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_product_price_history_tenant_product_effective_from"
      ON "product_price_history" ("tenant_id", "product_id", "effective_from")
    `);

    await queryRunner.query(`
      CREATE INDEX "IDX_product_price_history_active"
